...
extern "C"
{
	IRSSDK* SDAPI CreateRSClient(void);
	void SDAPI FreeRSClient(IRSSDK* pRsSDK);
	void WINAPI GetDllVersion(unsigned short* MajorVersion, unsigned short* MinorVersion, unsigned short* Revision, unsigned short* Build);
}

typedef IRSSDK* (*CREATERSCLIENT)();
typedef void (__stdcall *FREERSCLIENT)(IRSSDK* pRsSDK);


#define FN_CREATERSCLIENT			"CreateRSClient"
#define FN_FREERSCLIENT				"FreeRSClient"
