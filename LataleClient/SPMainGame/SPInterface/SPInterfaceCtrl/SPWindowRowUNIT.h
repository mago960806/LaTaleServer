// Copyright (C) DURAGON
//***************************************************************************
// System Name : List Row UNIT
// Comment     : 
// Creation    : DURAGON 2008-2-28    11:18 
//***************************************************************************
...
class SPWindowRowUNIT : public SPWindow
{
public:
	SPWindowRowUNIT( INSTANCE_ID InstanceID , int iX , int iY , int iCX , int iCY , SPWindow* pParent = NULL );
	virtual	~SPWindowRowUNIT();
	...
	void				SetOnTextColor		( D3DXCOLOR cColor );
	void				SetSelectAble		( bool bSelect ) ;
	void				SetSelectBG(char* pTextureFile, RECT* prcLeft, RECT* prcMiddle, RECT* prcRight) ;
