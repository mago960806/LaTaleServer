...
SPWindowFriendSnatchUser::SPWindowFriendSnatchUser(INSTANCE_ID InstanceID, int iX, int iY, int iCX, int iCY, SPWindow* pParent)
: SPWindow( WNDID_FRIEND_SNATCH , InstanceID, iX, iY, iCX, iCY, pParent )	
{
	Init();
}

SPWindowFriendSnatchUser::~SPWindowFriendSnatchUser()
{
	Clean();
}

void SPWindowFriendSnatchUser::Init()
{
	m_strToolTip	=	"[SPWindowFriendSnatchUser]";
...
void SPWindowFriendSnatchUser::Clean()
{
	SPWindow::Clean();
...
void SPWindowFriendSnatchUser::Show(bool bWithChild)
{
...
void SPWindowFriendSnatchUser::Hide(bool bSendServer)
{
...
void SPWindowFriendSnatchUser::ReposOwnImage()
{
...
void SPWindowFriendSnatchUser::RefreshRelationCoord()
{
	SPWindow::RefreshRelationCoord();
	ReposOwnImage();
}

void SPWindowFriendSnatchUser::Process(float fTime)
{
	SPWindow::Process( fTime );
}

void SPWindowFriendSnatchUser::Render(float fTime)
{
	...
	if( m_WindowState == WND_STATE_CLICK || m_WindowState == WND_STATE_HITTEST )
	{
		if( m_pBGTexture )
		{
			for( int i = 0 ; i < FRIENDSNATCHUSER_BG_COUNT ; i++ )
			{
...
bool SPWindowFriendSnatchUser::IsFriendInfo()
{
	bool bResult	=	false;
...
void SPWindowFriendSnatchUser::SetFriendInfo( FRIEND_INFO* pFriendInfo )
{
...
void SPWindowFriendSnatchUser::ShowToolTip( bool bShowToolTip )
{
	m_bShowToolTip	=	bShowToolTip;
}

const char* SPWindowFriendSnatchUser::GetName()
{
	return	m_pName->GetWindowText();
}

void SPWindowFriendSnatchUser::SetIconImage( const char* szImage , int iSrcX , int iSrcY )
{
	m_pIcon->SetImage( szImage , iSrcX , iSrcY );
}

void SPWindowFriendSnatchUser::SetIconImagePos( int iXPos , int iYPos )
{
	m_pIcon->AdjustCoord( iXPos , iYPos );
}

void SPWindowFriendSnatchUser::SetIconImageSize( int iXSize , int iYSize )
{
	m_pIcon->SetRectSize( iXSize , iYSize );
}

void SPWindowFriendSnatchUser::SetTextPos( int iXPos , int iYPos )
{
	m_pName->AdjustCoord( iXPos , iYPos );
}

void SPWindowFriendSnatchUser::SetTextSize( int iXSize , int iYSize )
{
	m_pName->SetRectSize( iXSize , iYSize );
}

void SPWindowFriendSnatchUser::SetTextColorOnLine( D3DXCOLOR cColor )
{
	m_cOnLineColor	=	cColor;
}

void SPWindowFriendSnatchUser::SetTextColorOffLine( D3DXCOLOR cColor )
{
	m_cOffLineColor	=	cColor;
}

void SPWindowFriendSnatchUser::SetWndState( WND_STATE eWndState )
{
	m_WindowState	=	eWndState;
}

SPIMESSAGE_OBJ_MAP_BEGIN( SPWindowFriendSnatchUser )
...
int SPWindowFriendSnatchUser::OnCursorEnter( WPARAM wParam, LPARAM lParam )
{
	int	iCursorX	=	g_pInterfaceManager->GetCursorX();
	int	iCursorY	=	g_pInterfaceManager->GetCursorY();
...
int SPWindowFriendSnatchUser::OnCursorOut( WPARAM wParam, LPARAM lParam )
{
...
int SPWindowFriendSnatchUser::OnCursorMove( WPARAM wParam, LPARAM lParam )
{
	int	iCursorX	=	g_pInterfaceManager->GetCursorX();
	int	iCursorY	=	g_pInterfaceManager->GetCursorY();
...
int SPWindowFriendSnatchUser::OnLButtonUp( WPARAM wParam, LPARAM lParam )
{
...
int SPWindowFriendSnatchUser::OnWheelUp( WPARAM wParam, LPARAM lParam )
{
	SPSendMessageToParent( SPIM_WHEEL_UP , wParam , lParam , this );
	return 1;
}

int SPWindowFriendSnatchUser::OnWheelDown( WPARAM wParam, LPARAM lParam )
{
	SPSendMessageToParent( SPIM_WHEEL_DOWN , wParam , lParam , this );
	return 1;
}

int SPWindowFriendSnatchUser::OnCursorEnter( unsigned int iID, WPARAM wParam , LPARAM lParam )
{
	OnCursorEnter( wParam , lParam );
	return 1;
}

int SPWindowFriendSnatchUser::OnCursorOut( unsigned int iID, WPARAM wParam , LPARAM lParam )
{
	OnCursorOut( wParam , lParam );
	return 1;
}

int SPWindowFriendSnatchUser::OnCursorMove( unsigned int iID, WPARAM wParam , LPARAM lParam )
{
	OnCursorMove( wParam , lParam );
	return 1;
}

int SPWindowFriendSnatchUser::OnLButtonUp( unsigned int iID, WPARAM wParam , LPARAM lParam )
{
	OnLButtonUp( wParam , lParam );
	return 1;
}

int SPWindowFriendSnatchUser::OnWheelUp( unsigned int iID, WPARAM wParam , LPARAM lParam )
{
	OnWheelUp( wParam , lParam );
	return 1;
}

int SPWindowFriendSnatchUser::OnWheelDown( unsigned int iID, WPARAM wParam , LPARAM lParam )
{
	OnWheelDown( wParam , lParam );
	return 1;
}

void SPWindowFriendSnatchUser::SetName( const char* pstrName )
{
	m_pName->SetWindowText( pstrName );
}

void SPWindowFriendSnatchUser::SetLevel( UINT8 uiLevel )
{
}

void SPWindowFriendSnatchUser::SetOnline( BOOL bOnline )
{
