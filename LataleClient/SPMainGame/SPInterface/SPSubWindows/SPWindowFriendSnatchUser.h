...
#define FRIENDSNATCHUSER_BG_COUNT					3
...
class SPWindowFriendSnatchUser : public SPWindow
{
public:
	SPWindowFriendSnatchUser( INSTANCE_ID InstanceID , int iX , int iY , int iCX , int iCY , SPWindow* pParent = NULL );
	virtual	~SPWindowFriendSnatchUser();
...
protected:
	...
	RECT				m_rcBGDest[ FRIENDSNATCHUSER_BG_COUNT ];
	RECT				m_rcBGSrc[ FRIENDSNATCHUSER_BG_COUNT ];
