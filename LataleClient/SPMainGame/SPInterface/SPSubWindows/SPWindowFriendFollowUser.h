...
#define FRIENDFOLLOWUSER_BG_COUNT					3
...
class SPWindowFriendFollowUser : public SPWindow
{
public:
	SPWindowFriendFollowUser( INSTANCE_ID InstanceID , int iX , int iY , int iCX , int iCY , SPWindow* pParent = NULL );
	virtual	~SPWindowFriendFollowUser();
...
protected:
	...
	RECT				m_rcBGDest[ FRIENDFOLLOWUSER_BG_COUNT ];
	RECT				m_rcBGSrc[ FRIENDFOLLOWUSER_BG_COUNT ];
